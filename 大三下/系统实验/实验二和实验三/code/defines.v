//////////////////////////////////////////////////////////////////////
// File:    defines.v
// Description: OpenMIPS 处理器全局宏定义
//             包含以下定义组:
//               - 通用常量: 使能/禁用、字宽等
//               - 指令编码 (opcode): 算术/逻辑/移位/跳转/加载存储等
//               - ALU 操作码 (AluOp): 8 位, 与指令一一对应
//               - ALU 结果选择 (AluSel): 3 位, 选择运算单元输出
//               - 指令/数据存储器参数: 地址总线、数据总线宽度
//               - 寄存器文件参数: 32 个 32 位寄存器
//               - 除法器状态: DivFree/DivByZero/DivOn/DivEnd
//               - CP0 寄存器地址: Count/Compare/Status/Cause/EPC/PrId/Config
//               - Wishbone 总线状态: WB_IDLE/WB_BUSY/WB_WAIT_FOR_FLUSHING/WB_WAIT_FOR_STALL
//////////////////////////////////////////////////////////////////////
