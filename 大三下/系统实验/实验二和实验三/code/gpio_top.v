//////////////////////////////////////////////////////////////////////
// File:    gpio_top.v
// Description: GPIO IP 核顶层模块 — 基于 OpenCores GPIO 项目
//             功能:
//               - 32 位通用输入输出 (GPIO) 控制器
//               - Wishbone 从设备接口
//               - 寄存器: RGPIO_IN(输入)/OUT(输出)/OE(方向)/INTE(中断使能)/PTRIG(触发)/CTRL(控制)/INTS(中断状态)
//               - 可配置输入同步策略 (GPIO_SYNC_IN_WB)
//               - 中断输出 (wb_inta_o)
//             在本 SoC 中: GPIO 连接 Nexys4 DDR 板载 LED、7 段数码管和按钮
//               - ext_pad_o[31:16]: LED 输出
//               - ext_pad_o[15:8]:  7 段数码管段选
//               - ext_pad_o[7:0]:   7 段数码管位选
//               - ext_pad_i[15:0]:  按钮/开关输入
//////////////////////////////////////////////////////////////////////
